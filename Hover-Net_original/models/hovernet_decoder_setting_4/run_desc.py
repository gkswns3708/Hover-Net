...
from run_utils.utils import save_image_from_batch
...
def train_step(batch_data, run_info):
    ...
    ####
    # print(run_info['net']['desc'].module.nr_types,"- run_desc-run_info['net']['desc'].module")
    ...
    # + 학습이 잘 진행되고 있는지 확인을 위한 image logging    
